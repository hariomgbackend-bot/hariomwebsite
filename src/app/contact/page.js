            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-xl p-5 border border-gray-100 text-center hover:shadow-md transition-shadow">
                  ...
                  <a href="mailto:contact@hariomelectronics.shop" className="text-sm text-brand-600 hover:text-accent-500">contact@hariomelectronics.shop</a>
                </div>
                ...
                <div className="bg-white rounded-xl p-5 border border-gray-100 text-center hover:shadow-md transition-shadow">
                  ...
                  <a href={`https://www.google.com/maps?q=${stores.find(s => s.isMain)?.coordinates.lat},${stores.find(s => s.isMain)?.coordinates.lng}`} target="_blank" rel="noopener noreferrer" className="text-xs text-brand-600 hover:text-accent-500 underline">Ram Krishan Complex, Alandi Road</a>
                </div>
              </div>
